...
(0, _gsap.gsap).registerPlugin((0, _motionPathPlugin.MotionPathPlugin), (0, _scrollTrigger.ScrollTrigger));
/* header parallax */ const headerParallax = (0, _gsap.gsap).timeline({
    scrollTrigger: {
...
headerParallax.to("#foliage-bottom-left", {
    ...
    top: "-10%",
    duration: 1
}, 0).to("#foliage-top-right", {
    top: "10%",
    duration: 1
}, 0);
/* main - train seat bckg */ (0, _gsap.gsap).to("#bckg-train-seat", {
    scrollTrigger: {
...
/* main - hiroshi scale */ (0, _gsap.gsap).to("#hiroshi-scale", {
    scrollTrigger: {
...
/* main - motion path papillon */ (0, _gsap.gsap).to("#butterfly-motion-path", {
    motionPath: {
        path: "#path",
        align: "#path",
        autoRotate: true,
...
/* main - memories wrapper */ const memoriesWrapper = (0, _gsap.gsap).timeline({
    scrollTrigger: {
...
memoriesWrapper.to("#hiroshi-miroir", {
    translateX: "100%"
}).to("#hiroshi-moto", {
    translateX: "-100%"
}, "-=0.4").to("#nuage", {
    translateX: "100%"
}, "-=0.4").to("#hiroshi-baffe", {
    translateX: "-100%"
}, "-=0.4").to("#plonge-1", {
    translateY: "-30%"
}, "-=0.4").to("#plonge-2", {
    ...
    translateY: "-120%"
}, "-=0.4").to("#hiroshi-with-girl", {
    translateX: "100%"
}, "-=0.4").to("#hiroshi-walk-in-city", {
    translateX: "-100%"
}, "-=0.4");
...
},{"gsap/dist/gsap":"kewLB","gsap/dist/ScrollTrigger":"eCiMu","gsap/dist/MotionPathPlugin":"5hwEr"}],"kewLB":[function(require,module,exports) {
...
},{}],"eCiMu":[function(require,module,exports) {
(function(global, factory) {
    factory(exports);
})(this, function(exports1) {
    "use strict";
    ...
    var ScrollTrigger$1 = function() {
        ...
        _proto.init = function init(vars, animation) {
            ...
            self.refresh = function(soft, force, position, pinOffset) {
                ...
                if (isFirstRefresh) prevProgress = gsap$1.utils.clamp(0, 1, gsap$1.utils.normalize(start, end, prevScroll));
                ...
                if (pin && !(_clampingMax && self.end >= _maxScroll(scroller, direction))) {
                    ...
                    if (!max && end > 1) {
                        ...
                        if (isViewport && _getComputedStyle(_body$1)["overflow" + direction.a.toUpperCase()] !== "scroll") forcedOverflow.style["overflow" + direction.a.toUpperCase()] = "scroll";
                    }
                    _swapPinIn(pin, spacer, cs);
                    pinState = _getState(pin);
            ...
            self.update = function(reset, recordVelocity, forceFake) {
                ...
                if (anticipatePin && pin && !_refreshing && !_startup$1 && _lastScrollTime) {
                    if (!clipped && start < scroll + (scroll - scroll2) / (_getTime$1() - _time2) * anticipatePin) clipped = 0.0001;
                    else if (clipped === 1 && end > scroll + (scroll - scroll2) / (_getTime$1() - _time2) * anticipatePin) clipped = 0.9999;
                }
...
},{}],"5hwEr":[function(require,module,exports) {
(function(global, factory) {
    factory(exports);
})(this, function(exports1) {
    "use strict";
    ...
    function rawPathToString(rawPath) {
        if (_isNumber(rawPath[0])) rawPath = [
            rawPath
        ];
	 ...
	 * Club GSAP members, the agreement issued with that membership.
	 * @author: Jack Doyle, jack@greensock.com
	*/ var _xProps = "x,translateX,left,marginLeft,xPercent".split(","), _yProps = "y,translateY,top,marginTop,yPercent".split(","), _DEG2RAD$1 = Math.PI / 180, gsap, PropTween, _getUnit, _toArray, _getStyleSaver, _reverting, _getGSAP = function _getGSAP() {
        return gsap || typeof window !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap;
    ...
    var MotionPathPlugin = {
        ...
        arrayToRawPath: function arrayToRawPath(value, vars) {
            ...
            vars.relative && _relativize(segment);
            return [
                vars.type === "cubic" ? segment : pointsToSegment(segment, vars.curviness)
            ];
        }
    };
    _getGSAP() && gsap.registerPlugin(MotionPathPlugin);
    exports1.MotionPathPlugin = MotionPathPlugin;
    exports1.default = MotionPathPlugin;
